...
// results.innerHTML = "city" + " " + city + " ";
// results.innerHTML += "is Where I live!"
    results.innerHTML="My name is" + " "+ (myName) + "."  +" " + "I'm" + " "+ (age)+" " +  "years old." +" " + "I'm from" + " " + (city) + "," + " " +  "and I'm very" + " " + (mood) + " " +  "I love to eat" + " " + (food);
